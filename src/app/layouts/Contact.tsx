  ...
  return (
    <div className="relative py-5">
      <div className="flex flex-row">
        <div className="basis-1/3 border-y border-y-custom-blue-800 dark:border-y-custom-blue-500 bg-custom-blue-800 dark:bg-custom-blue-500 h-48"></div>
        <div className="basis-1/3 bg-custom-blue-800 dark:bg-custom-blue-500 h-48"></div>
        <div className="basis-1/3 border-y border-y-custom-blue-800 dark:border-y-custom-blue-500 bg-custom-blue-800 dark:bg-custom-blue-500 h-48"></div>
      </div>
          ...
          <div className="flex flex-row space-x-3 justify-center my-14">
            <div className="border px-3 py-2 rounded-sm border-custom-blue-500 dark:border-custom-blue-500 bg-custom-blue-500 dark:bg-custom-blue-800">
              ...
              >
                ...
                <span className="text-custom-beige-500 dark:text-custom-beige-500 font-light text-sm">
                  me@kaixsean.com
                </span>
              </a>
            </div>
